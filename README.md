...
This repository contains the demonstration application for the **Track 2 model of the [2026 IEEE Low-Power Computer Vision Challenge (LPCVC)]** [1] running on physical mobile edge devices. 

The goal of track 2 is **Action Recognition in Video**.

The system has been validated on **Android 16** and **Samsung Galaxy S25 & S26** hardware.
